    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- <img style="height: 105px; width: 290px; " src="{{ asset('img/logo.png') }}"> -->
                    <h1 style="margin-left: 35%; font-size:28px;margin-bottom: 35px;">Регистрация</h1>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button onclick='document.location.href = "/login"';  class="btn btn-primary">
                                    {{ __('Войти') }}
                                </button>
