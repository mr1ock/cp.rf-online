                ...
                <div class="col-md-6 side_bar">
                   <div class="row">
                       <div class="col-md menu_btn">
                           <div class="row">
                               <div class="col-md-12">
                               <a class="link_menu cursor1" href="{{  route('admin')  }}">
                                        <div class="d-flex justify-content-center">
                                            <div class="icon_1"></div>
                                        </div>
                                        <p class="btn_title d-flex justify-content-center">Admin</p>
                                   </a>
                               </div>
                           </div>
                       ...
                       {{-- <div class="col-md menu_btn">
                            <div class="row">
                               <div class="col-md-12">
                                   <a class="link_menu cursor2" href="#">
                                        <div class="d-flex justify-content-center">
                       ...
                       {{-- <div class="col-md menu_btn">
                            <div class="row">
                               <div class="col-md-12">
                                   <a class="link_menu cursor3" href="#">
                                        <div class="d-flex justify-content-center">
                       ...
                       {{-- <div class="col-md menu_btn">
                            <div class="row">
                               <div class="col-md-12">
                                   <a class="link_menu cursor4" href="#">
                                        <div class="d-flex justify-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="#"><img class="img_icon_money"  src="{{ asset('img/money2.png') }}"></a>
                                        <p class="money"></p>
                                    </div>
                                </div>
                            </div>
